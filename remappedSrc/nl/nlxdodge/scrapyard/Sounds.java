...
public class Sounds {
    ...
    public static final Identifier SILVER_FISH_SPRAY_USAGE = new Identifier("scrapyard:silver_fish_spray_usage");
    public static final Identifier BALLOON_BLOCK_JUMP = new Identifier("scrapyard:balloon_block_jump");
