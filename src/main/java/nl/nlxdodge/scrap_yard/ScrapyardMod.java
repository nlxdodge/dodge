...
public class ScrapyardMod implements ModInitializer {
	...
	public static final Item GLASS_SWORD = new GlassSword(ToolMaterials.GLASS, 2, 1.5f, new Item.Settings().group(SCRAP_YARD_GROUP));
	public static final Block SCRAP_BLOCK = new ScrapBlock(
			AbstractBlock.Settings.of(Material.METAL, MaterialColor.BROWN).strength(1.0F).sounds(BlockSoundGroup.LODESTONE));
