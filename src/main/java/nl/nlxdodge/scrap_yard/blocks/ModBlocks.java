...
public class ModBlocks {
    ...
    public static final Block RECYCLER_BLOCK = new RecyclerBlock(AbstractBlock.Settings.of(Material.METAL, MaterialColor.GREEN));
    ...
    public static void registerBlocks() {
        ...
        Registry.register(Registry.ITEM, new Identifier("scrap_yard", "recycler_block"),
                new BlockItem(RECYCLER_BLOCK, new Item.Settings().group(ScrapyardMod.SCRAP_YARD_GROUP)));
